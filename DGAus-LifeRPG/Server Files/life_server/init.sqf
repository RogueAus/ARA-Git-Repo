...
//[8,true,12] execFSM "\life_server\FSM\timeModule.fsm"; //OLD TIME MODULE
//setTimeMultiplier 0.1; //New Time Multiplier | 1 hour irl = 6 minutes ig //Static Time
[] spawn life_fnc_time; //New time script
...
fed_bank setVariable ["safe",9 + (round(random 5)),true];
...
private["_dome"];
_dome = nearestObject [[5654.92,8896.03,0.4],"Land_Research_house_V1_F"];
