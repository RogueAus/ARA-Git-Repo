...
if!(EQUAL(typeName _sp,typeName "")) then {
	_nearVehicles = nearestObjects[_sp,["Car","Air","Ship","Tank","Car_F","Truck_F"],10];
} else {
	_nearVehicles = [];
};
...
if(EQUAL(SEL(_vInfo,1),"cop") && (SEL(_vInfo,2)) in ["C_Offroad_01_F","B_MRAP_01_F","C_SUV_01_F","C_Hatchback_01_sport_F","B_Heli_Light_01_F","B_Heli_Transport_01_F","sab_UN_Offroad","sab_UN_SUV","sab_UN_Hunter","DG_TSF_ARMED_OFFROAD","DG_TSF_Offroad","DG_TSF_SUV","DG_TSF_HUNTER"]) then {
