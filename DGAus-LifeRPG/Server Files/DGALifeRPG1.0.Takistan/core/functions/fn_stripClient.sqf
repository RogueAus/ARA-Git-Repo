...
_safeItems = ["FirstAidKit","ItemMap","ItemCompass","ItemWatch","NVGoggles","Binocular"];
_unit = player;

[_unit,"patdown"] remoteExec ["life_fnc_say3D",RANY];	

titleText[localize "Your weapons have been removed.","PLAIN"];
...
}forEach [_hgItems, _pwItems, _swItems, _asItems, _inItems];
