			...
			if(count _sPos > 1 && {_distance < 15}) then {
				_text = switch (true) do {
					...
					case (side _x == west && {!isNil {_x GVAR "rank"}}): {format["<img image='%1' size='1'></img> %2",switch ((_x GVAR "rank")) do {
						...
						case 10: {"\a3\ui_f\data\gui\cfg\Ranks\corporal_gs.paa"};
						case 11: {"\a3\ui_f\data\gui\cfg\Ranks\sergeant_gs.paa"};
						case 12: {"\a3\ui_f\data\gui\cfg\Ranks\sergeant_gs.paa"};
						case 13: {"\a3\ui_f\data\gui\cfg\Ranks\lieutenant_gs.paa"};
						case 14: {"\a3\ui_f\data\gui\cfg\Ranks\lieutenant_gs.paa"};
						case 15: {"\a3\ui_f\data\gui\cfg\Ranks\captain_gs.paa"};
						case 16: {"\a3\ui_f\data\gui\cfg\Ranks\major_gs.paa"};
						case 17: {"\a3\ui_f\data\gui\cfg\Ranks\colonel_gs.paa"};
