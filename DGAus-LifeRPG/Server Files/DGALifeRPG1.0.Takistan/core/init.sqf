...
*/
player setVariable["tf_receivingDistanceMultiplicator", 1.0];
...
player SVAR ["isZiptied",false,true];
player SVAR ["isHandcuffed",false,true];
...
[] execVM "core\loopThreatAlert.sqf";
[] call dgaus_fnc_csgas;
