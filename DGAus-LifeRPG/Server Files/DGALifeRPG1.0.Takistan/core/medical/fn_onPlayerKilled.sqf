...
outlw_MR_canCreateDialog = false; // Disable Mag Repack
_unit SVAR ["name",profileName,true]; //Set my name so they can say my name.
_unit SVAR ["restrained",false,true];
_unit SVAR ["isZiptied",false,true];
_unit SVAR ["isHandcuffed",false,true];
...
deleteMarker "My Death Location";
life_lastKnownPos = [0,0,0];
[getPos player] spawn life_fnc_nlrMarker;
