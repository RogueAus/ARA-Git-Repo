...
{
	//DGAus Custom
	case "sab_UN_Offroad": //UN Offroad
	{
		_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];
	};
	
	case "sab_UN_SUV": //UN SUV 
	{
		_lightleft lightAttachObject [_vehicle, [-0.37,-1.2,0.42]];
	};
	
	case "sab_UN_Hunter": //UN Hunter
	{
		_lightleft lightAttachObject [_vehicle, [-0.37, -1.9, 0.7]];
	};
	
	case "DG_TSF_Offroad": //TSF Offroad
	{
		_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];
	};
	
	case "DG_TSF_SUV": //TSF SUV 
	{
		_lightleft lightAttachObject [_vehicle, [-0.37,-1.2,0.42]];
	};
	
	case "DG_TSF_HUNTER": //TSF Hunter
	{
		_lightleft lightAttachObject [_vehicle, [-0.37, -1.9, 0.7]];
	};
	
	case "DG_TSF_ARMED_OFFROAD": //TSF Offroad Armed
	{
		_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];
	};
};
