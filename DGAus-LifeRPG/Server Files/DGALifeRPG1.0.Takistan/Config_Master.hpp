...
class Life_Settings {
	...
	//save_player_location = false; //Save Player's Location
	//save_veh_location = false; //Save Vehicle Location
    ...
    /* Car-shop Settings */
    vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F",  "B_Boat_Armed_01_minigun_F", "CUP_I_BTR40_MG_TKG", "CUP_B_LR_Special_M2_GB_D", "CUP_O_GAZ_Vodnik_PK_RU", "CUP_B_RG31_M2_OD_USMC", "CUP_B_Dingo_CZ_Wdl", "CUP_O_GAZ_Vodnik_BPPU_RU", "CUP_B_BRDM2_CDF", "CUP_B_BRDM2_ATGM_CD", "CUP_O_Ural_ZU23_RU", "CUP_O_BMP2_TKA", "CUP_I_T34_NAPA", "CUP_O_T55_TK", "CUP_B_T72_CDF", "CUP_O_T90_RU", "CUP_B_ZSU23_CDF" };

    /* Job-related stuff */
    delivery_points[] = { "dp_1", "dp_2", "dp_3", "dp_4", "dp_5", "dp_6", "dp_7", "dp_8", "dp_9", "dp_10", "dp_11", "dp_12", "dp_13", "dp_14", "dp_15", "dp_15", "dp_16", "dp_17", "dp_18", "dp_19", "dp_20", "dp_21", "dp_22", "dp_23", "dp_24" };
